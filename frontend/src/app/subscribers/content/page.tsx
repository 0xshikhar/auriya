          ...
          {subscriptions.map((sub) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-gumroad-pink to-purple-500 rounded-full flex items-center justify-center">
                  <User className="w-6 h-6 text-white" />
                </div>
                <div className="flex-1">
                  <p className="font-semibold text-black">Creator</p>
              ...
              <div className="flex gap-2">
                <Link href={`/creators/${sub.creator}`} className="flex-1">
